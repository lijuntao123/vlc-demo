...
public class VlcVideoActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// mMediaPlayer.getMediaList().add(new Media(mMediaPlayer,
		// "http://live.3gv.ifeng.com/zixun.m3u8"), false);
		...
		if (url != null && !"".equals(url)) {
			...
			mMediaPlayer
					.playMRL("rtsp://218.204.223.237:554/live/1/66251FC11353191F/e7ooqwcfbqjoo80j.sdp");
		}
